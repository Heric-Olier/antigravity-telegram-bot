...
export const zh: I18nDictionary = {
  ...
  "bot.prompt_send_error": "向 Antigravity 发送请求失败。",
  "bot.session_error": "🔴 Antigravity 返回错误：{message}",
  ...
  "bot.media_group_not_processed":
    "⚠️ 此相册中有一个或多个文件无法处理。未向 Antigravity 发送任何内容。",
  "bot.media_group_download_error": "🔴 无法下载其中一个文件。未向 Antigravity 发送任何内容。",
  ...
  "status.header_running": "🟢 Antigravity 服务器正在运行",
  "status.health.healthy": "健康",
  "status.health.unhealthy": "不健康",
  "status.line.health": "状态：{health}",
  "status.line.version": "Antigravity 版本：{version}",
  ...
  "projects.empty":
    "📭 未找到项目。\n\n在 Antigravity 中打开一个目录并至少创建一个会话，然后它会出现在这里。",
  ...
  "projects.fetch_error": "🔴 Antigravity 服务器不可用，或加载项目时发生错误。",
  ...
  "sessions.fetch_error": "🔴 Antigravity 服务器不可用，或加载会话时发生错误。",
  ...
  "messages.fetch_error": "🔴 Antigravity Server 不可用，或加载消息时发生错误。",
  ...
  "detach.success":
    "✅ 已从会话分离：{title}\n\nAntigravity 会话未停止。如果它仍在运行，将继续独立执行。稍后可通过 /sessions 重新选择它来查看。",
  "detach.error": "🔴 无法从当前会话分离。",

  "new.project_not_selected": "🏗 未选择项目。\n\n请先使用 /projects 选择一个项目。",
  "new.created": "✅ 新会话已创建：{title}",
  "new.create_error": "🔴 Antigravity 服务器不可用，或创建会话时发生错误。",
  ...
  "opencode_start.already_running_managed":
    "⚠️ Antigravity 服务器已在运行\n\nPID：{pid}\n运行时间：{seconds} 秒",
  "opencode_start.already_running_external":
    "✅ Antigravity 服务器正作为外部进程运行\n\n版本：{version}\n\n该服务器不是由机器人启动，因此 /opencode-stop 无法停止它。",
  "opencode_start.already_running": "✅ Antigravity 服务器已在运行\n\n版本：{version}",
  "opencode_start.remote_configured": "⚠️ /opencode_start 仅适用于本地 Antigravity 服务器。",
  "opencode_start.starting": "🔄 正在启动 Antigravity 服务器...",
  "opencode_start.start_error":
    "🔴 启动 Antigravity 服务器失败\n\n错误：{error}\n\n请检查 Antigravity CLI 已安装且在 PATH 中可用：\nopencode --version\nnpm install -g @opencode-ai/cli",
  "opencode_start.started_not_ready":
    "⚠️ Antigravity 服务器已启动，但未响应\n\nPID：{pid}\n\n服务器可能仍在启动中。几秒后试试 /status。",
  "opencode_start.success": "✅ Antigravity 服务器启动成功\n\nPID：{pid}\n版本：{version}",
  "opencode_start.error": "🔴 启动服务器时发生错误。\n\n请查看应用日志了解详情。",
  "opencode_stop.external_running":
    "⚠️ Antigravity 服务器正作为外部进程运行\n\n该服务器不是通过 /opencode-start 启动的。\n请手动停止它，或使用 /status 检查状态。",
  "opencode_stop.remote_configured": "⚠️ /opencode_stop 仅适用于本地 Antigravity 服务器。",
  "opencode_stop.not_running": "⚠️ Antigravity 服务器未运行",
  "opencode_stop.pid_not_found":
    "⚠️ Antigravity 服务器正在端口 {port} 上响应，但未找到可停止的本地进程。",
  "opencode_stop.stopping": "🛑 正在停止 Antigravity 服务器...\n\nPID：{pid}",
  "opencode_stop.stop_error": "🔴 停止 Antigravity 服务器失败\n\n错误：{error}",
  "opencode_stop.still_running": "停止请求后服务器仍在响应。",
  "opencode_stop.success": "✅ Antigravity 服务器已成功停止",
  ...
  "model.menu.favorites_title": "⭐ 收藏（可在 Antigravity CLI 中将模型加入收藏）",
  "model.menu.favorites_empty": "— 列表为空。",
  "model.menu.recent_title": "🕘 最近使用",
  "model.menu.recent_empty": "— 列表为空。",
  "model.menu.favorites_hint": "ℹ️ 可在 Antigravity CLI 中将模型加入收藏，使其显示在列表顶部。",
  ...
  "commands.select": "请选择一个 Antigravity 命令：",
  "commands.empty": "📭 当前项目没有可用的 Antigravity 命令。",
  "commands.fetch_error": "🔴 加载 Antigravity 命令失败。",
  ...
  "commands.execute_error": "🔴 执行 Antigravity 命令失败。",
  "commands.select_page": "请选择一个 Antigravity 命令（第 {page} 页）：",
  ...
  "skills.select": "请选择一个 Antigravity 技能：",
  "skills.empty": "📭 当前项目没有可用的 Antigravity 技能。",
  "skills.fetch_error": "🔴 加载 Antigravity 技能失败。",
  ...
  "skills.select_page": "请选择一个 Antigravity 技能（第 {page} 页）：",
  ...
  "legacy.models.empty": "📋 没有可用模型。请在 Antigravity 中配置 providers。",
